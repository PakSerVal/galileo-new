<template>
  <div class="homepage">
    ...
    <section class="homepage__courses">
      <CoursesList/>
    </section>
      ...
      <v-layout column wrap class="my-5 homepage__info" align-center>
        <v-flex xs12 sm4 class="my-3">
          <div class="text-xs-center">
            ...
            <span class="subheading">Лучший способ сдать экзамены!</span>
          </div>
        </v-flex>
        <v-flex>
...
<script>
  ...
  export default {
    components: {CoursesList, EnrollButton},
    data() {
      return {
        items:    [
          {
            src: 'img/galileo/home-background.jpeg'
          },
          {
